...
theme.border_focus  = theme.cbpurple -- "#7985A3"
...
-- Example:
theme.taglist_fg_focus = theme.cbpurple
theme.tasklist_fg_focus = theme.cbpurple
...
theme.menu_border_color = theme.cpurple
